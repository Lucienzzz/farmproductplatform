...
import org.zzq.farmproductplatform.model.service.IMailService;
import org.zzq.farmproductplatform.model.service.IStoreService;
import org.zzq.farmproductplatform.model.service.IUserService;
...
public class UserController {
    ...
    public String login(@RequestParam(value = "username", required = false) String username,
        ...
        if (!sub.isAuthenticated()) {
            ...
            try {
                ...
                Store curStore = storeService.findStoreByUserId(loginUser.getUserId());
                request.getSession().setAttribute("loginStore", curStore);
    ...
    public String register(User user, Model model) {
        ...
        if ((Boolean) isExist.getData()) {
            ...
            try {
                mailService.sendHtmlMail(user.getEmail(), "（农产品销售平台）---用户激活---",
